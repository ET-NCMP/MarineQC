...
class Testpentad_to_month(unittest.TestCase):
...
class Testday_in_year(unittest.TestCase):
...
class TestQCMethods_get_hires_sst(unittest.TestCase):
...
class TestQCMethods_hard_limit(unittest.TestCase):
...
class TestQCMethods_blacklist(unittest.TestCase):
    ...
    def test_fail_zero_lat_zero_lon_fail(self):
        result = qc.blacklist(None, 980, 1850, 1, 0, 0)
        self.assertEqual(result,1)

    def test_fail_SEAS(self):
        result = qc.blacklist(None, 874, 1850, 1, 0, 1)
        self.assertEqual(result,1)

    def test_fail_CMAN(self):
        result = qc.blacklist(None, 732, 1850, 1, 0, 1, 13)
        self.assertEqual(result,1)
    
    def test_obvious_pass(self):
        result = qc.blacklist(None, 732, 1850, 1, 0, 1)
        self.assertEqual(result,0)

    def test_obvious_fails(self):
        result = qc.blacklist(None, 732, 1958, 1, 45, -172)
        self.assertEqual(result,1)
        result = qc.blacklist(None, 732, 1974, 1, -47, -60)
        self.assertEqual(result,1)

    def test_obvious_fails_shifted_long(self):
        result = qc.blacklist(None, 732, 1958, 1, 45, -172+360)
        self.assertEqual(result,1)
        result = qc.blacklist(None, 732, 1974, 1, -47, -60+360)
        self.assertEqual(result,1)

    def test_right_area_wrong_callsign_passes(self):
        result = qc.blacklist(None, 731, 1958, 1, 45, -172)
        self.assertEqual(result,0)
        result = qc.blacklist(None, 731, 1974, 1, -47, -60)
        self.assertEqual(result,0)

    def test_right_area_wrong_year_passes(self):
        result = qc.blacklist(None, 732, 1957, 1, 45, -172)
        self.assertEqual(result,0)
        result = qc.blacklist(None, 732, 1975, 1, -47, -60)
        self.assertEqual(result,0)
...
class TestQCMethods_yindex_to_lat(unittest.TestCase):
...
class TestQCMethods_xindex_to_lon(unittest.TestCase):
...
class TestQCMethod_missing_mean(unittest.TestCase):
...
class TestQCMethod_fill_missing_values(unittest.TestCase):
...
class TestQCMethods_get_four_surrounding_points(unittest.TestCase):
...
class TestQCMethods_bilinear(unittest.TestCase):
...
class TestQCMethods_mdslat_and_lon(unittest.TestCase):
...
class TestQCMethods_pgross(unittest.TestCase):
...
class TestQCMethods_p_data_given_gross(unittest.TestCase):
