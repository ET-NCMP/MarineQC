...
def distr1(invoyage):
    ...
    for i in range(1, nobs):
        ...
        if (invoyage.getvar(i, 'vsi') is not None and
                invoyage.getvar(i - 1, 'vsi') is not None and
                invoyage.getvar(i, 'dsi') is not None and
                invoyage.getvar(i - 1, 'dsi') is not None and
                invoyage.getvar(i, 'time_diff') is not None):
